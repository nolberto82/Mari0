function game_load(suspended)
	...
	custommusic = false
	if love.filesystem.getInfo("mappacks/" .. mappack .. "/music.wav") then
		custommusic = "mappacks/" .. mappack .. "/music.wav"
		music:load(custommusic)
	elseif love.filesystem.getInfo("mappacks/" .. mappack .. "/music.wav") then
		custommusic = "mappacks/" .. mappack .. "/music.wav"
		music:load(custommusic)
	end
	print(custommusic)
...
function game_mousepressed(x, y, button)
	if pausemenuopen or not pausemenuopen then
		return
	end
